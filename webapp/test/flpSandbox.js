		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "training",
									"targetURL": "#uiMyFirstProjecttraining-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"uiMyFirstProjecttraining-display": {
								"semanticObject": "uiMyFirstProjecttraining",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui.MyFirstProject.training",
									"url": sap.ui.require.toUrl("ui/MyFirstProject/training")
								}
							}
						}
					}
